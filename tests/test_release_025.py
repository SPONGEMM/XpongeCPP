"""Release-contract checks for the Xponge-origin 1.7b10 alignment."""
...
def test_release_version_and_compatibility_target():
    ...
    assert metadata["version"] == XpongeCPP.__version__ == "0.2.6"
    assert "Xponge-origin 1.7b10" in metadata["description"]
