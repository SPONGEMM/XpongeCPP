"""Register GLYCAM-06j D-pyranose templates and linkage semantics."""
...
for code, terminal, conformation in product("ABCDEFGHJKLMNOPQRSTUVWXYZ", "012346789PQRSTUVWXYZ", "AB"):
