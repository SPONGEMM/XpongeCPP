"""Register GLYCAM-06j L-furanose templates and linkage semantics."""
...
register_residue_templates_from_mol2_file(str(data_path("glycam_06j/l_furanose.mol2")))

for code, terminal, conformation in product("ABCDEFGHJKLMNOPQRSTUVWXYZ".lower(), "012346789PQRSTUVWXYZ", "UD"):
